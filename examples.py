...
# test 2
mylcd.lcd_display_string_pos("RPi I2C test", 1,0)
mylcd.lcd_display_string(" Custom chars", 2)


mylcd.lcd_display_string_pos("Maria Elena Walsh", 1,0)
mylcd.lcd_display_string("Twist del mono liso", 2)
...
fontdata1 = [
        ...
        # Char 6 - my test
	[ 0x0,0x1,0x2,0x4,0x8,0x4,0x2,0x1],
]
...
mylcd.lcd_display_string_pos(chr(0),1,2)
mylcd.lcd_display_string_pos(chr(5),1,9)
pos = 6
